...
class __TwigTemplate_6f4c116146301af476c25becd96711a5d08da1f838d78d1180506512c71c69a2 extends \Twig\Template
{
...
";
    ...
    public function block_webservice_key_form($context, array $blocks = [])
    {
        // line 29
        echo "  ";
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), 'form_start');
        echo "
  <div class=\"card\">
    ...
    <div class=\"card-block row\">
      <div class=\"card-text\">
        ";
        // line 36
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), 'errors');
        echo "

        ";
        // line 38
        echo $context["ps"]->getform_group_row($this->getAttribute((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), "key", []), [], ["label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Key", [], "Admin.Advparameters.Feature"), "help" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Webservice account key.", [], "Admin.Advparameters.Feature")]);
        // line 41
        echo "

        ";
        // line 43
        echo $context["ps"]->getform_group_row($this->getAttribute((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), "description", []), [], ["label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Key description", [], "Admin.Advparameters.Feature"), "help" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Quick description of the key: who it is for, what permissions it has, etc.", [], "Admin.Advparameters.Help")]);
        // line 46
        echo "

        ";
        // line 48
        echo $context["ps"]->getform_group_row($this->getAttribute((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), "status", []), [], ["label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Status", [], "Admin.Global")]);
        // line 50
        echo "
        ...
        ";
        // line 61
        echo $context["ps"]->getform_group_row($this->getAttribute((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), "permissions", []), ["label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Resource", [], "Admin.Global")], ["label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Permissions", [], "Admin.Advparameters.Feature")]);
        // line 65
        echo "

        ";
        // line 67
        if ($this->getAttribute((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), "shop_association", [], "any", true, true)) {
            // line 68
            echo "          ";
            echo $context["ps"]->getform_group_row($this->getAttribute((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), "shop_association", []), [], ["label" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\TranslationExtension')->trans("Shop association", [], "Admin.Global")]);
            // line 70
            echo "
        ";
        }
  ...
  ";
        // line 87
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), 'form_end');
        echo "
";
    }
    ...
    public function block_webservice_key_form_rest($context, array $blocks = [])
    {
        // line 74
        echo "          ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock((isset($context["webserviceKeyForm"]) ? $context["webserviceKeyForm"] : null), 'rest');
        echo "
        ";
    }
