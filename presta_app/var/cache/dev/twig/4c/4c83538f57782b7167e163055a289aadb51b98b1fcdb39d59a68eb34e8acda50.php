...
class __TwigTemplate_18dba93b26a36254e3c157f8f2e270ec3857c308a2acd866c329d7c935d6409a extends \Twig\Template
{
  ...
  <script>
    \$('body').on(
      ...
      function() {
        ";
        // line 33
        if ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", []), "get", [0 => "filterCategoryTab"], "method")) {
            // line 34
            echo "        \$('.module-category-menu[data-category-tab=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", []), "get", [0 => "filterCategoryTab"], "method"), "html", null, true);
            echo "\"]').click();
        ";
        }
        // line 36
        echo "        ";
        if ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", []), "get", [0 => "filterCategoryRef"], "method")) {
            // line 37
            echo "        \$('.module-category-menu[data-category-ref=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "request", []), "get", [0 => "filterCategoryRef"], "method"), "html", null, true);
            echo "\"]').click();
        ";
        }
        // line 39
...
";
    ...
    <div class=\"col-lg-10 module-catalog-page\">
      ";
        // line 48
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_addons_connect.html.twig", "@PrestaShop/Admin/Module/catalog.html.twig", 48)->display(twig_array_merge($context, ["level" => (isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : $this->getContext($context, "errorMessage"))]));
        // line 49
        echo "      ";
        // line 50
        echo "      ";
        ...
        // line 52
        echo "      ";
        $this->loadTemplate("@PrestaShop/Admin/Module/Includes/modal_import.html.twig", "@PrestaShop/Admin/Module/catalog.html.twig", 52)->display(twig_array_merge($context, ["level" => (isset($context["level"]) ? $context["level"] : $this->getContext($context, "level")), "errorMessage" => (isset($context["errorMessage"]) ? $context["errorMessage"] : $this->getContext($context, "errorMessage"))]));
        // line 53
        echo "      ";
        // line 54
        echo "      ";
        ...
        if ($this->getAttribute((isset($context["topMenuData"]) ? $context["topMenuData"] : null), "categories", [], "any", true, true)) {
            // line 59
            echo "        ";
            $this->loadTemplate("@PrestaShop/Admin/Module/Includes/categories_grid.html.twig", "@PrestaShop/Admin/Module/catalog.html.twig", 59)->display(twig_array_merge($context, ["categories" => $this->getAttribute((isset($context["topMenuData"]) ? $context["topMenuData"] : $this->getContext($context, "topMenuData")), "categories", [])]));
            // line 60
            echo "      ";
        }
        // line 61
