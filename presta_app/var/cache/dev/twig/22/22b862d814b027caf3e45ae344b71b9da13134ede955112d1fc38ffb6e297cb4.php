...
class __TwigTemplate_56eb311b3f5c7c6ab9e83882affc8d17d1872ae3ddf3448b2f830505ccff10cd extends \Twig\Template
{
...
";
    ...
    public function block_category_menu_thumbnails($context, array $blocks = [])
    {
        ...
        // line 27
        echo "  ";
        if (((isset($context["menuThumbnailImages"]) || array_key_exists("menuThumbnailImages", $context)) &&  !twig_test_empty((isset($context["menuThumbnailImages"]) ? $context["menuThumbnailImages"] : $this->getContext($context, "menuThumbnailImages"))))) {
            // line 28
            echo "    <div>
      ";
            // line 29
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["menuThumbnailImages"]) ? $context["menuThumbnailImages"] : $this->getContext($context, "menuThumbnailImages")));
          ...
          <figcaption class=\"figure-caption\">
            <button class=\"btn btn-outline-danger btn-sm js-form-submit-btn\"
                ...
                // line 34
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("admin_categories_delete_menu_thumbnail", ["categoryId" => $this->getAttribute($this->getAttribute((isset($context["editableCategory"]) ? $context["editableCategory"] : $this->getContext($context, "editableCategory")), "id", []), "value", []), "menuThumbnailId" => $this->getAttribute($context["menuThumbnail"], "id", [])]), "html", null, true);
                echo "\"
